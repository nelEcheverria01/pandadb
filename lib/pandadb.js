...
class PandaDB {
  ...
  async #create (collection, data) {
    if (typeof data !== 'object') throw new Error('the data to be created must be of type string')
  ...
  async #createMany (collection, arrData) {
    ...
    arrData.forEach(e => {
      if (typeof e !== 'object') throw new Error('the elements of the provided array must be of type object')
    })
