...
class PandaDB {
  ...
  collection (name) {
    if (typeof name !== 'string') throw new Error('the collection name must be of type string')
  ...
  async #create (collection, data) {
    if (typeof data !== 'object' || Array.isArray(data)) throw new Error('the data to be created must be of type string')
  ...
  async #createMany (collection, arrData) {
    if (!Array.isArray(arrData)) throw new Error('the data argument must be an array')
    arrData.forEach(e => {
      if (typeof e !== 'object' || Array.isArray(e)) throw new Error('the elements of the provided array must be of type object')
    })
  ...
  async #find (collection, query) {
    if (typeof query !== 'object' || Array.isArray(query)) throw new Error('the query to be made must be of type object')
  ...
  async #edit (collection, query, newData) {
    ...
    if (typeof newData !== 'object') throw new Error('the data to be updated must be of object type')
